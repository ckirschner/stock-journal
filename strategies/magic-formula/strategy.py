    ...
    "inputs": [
        ...
        {"id": "free-cash", "label": "Free cash", "type": "number",
         ...
         "explain": "Money in the account this journal covers that is not "
                    ...
                    "the account total, and that total is what an equal "
                    "share of the portfolio is measured against. Until "
                    "the record is opened the size says it cannot be "
                    "worked out rather than guessing at it.\n\n"
